...
def start_image_analyzer(folder_path="analyzer"):
    ...
    """
    try:
        # Ensure folder exists before starting observer
        ...
        print(f"[ERROR] Failed to start image analyzer: {e}")
        print("[INFO] Image analyzer will be disabled. Atlas will continue without it.")
